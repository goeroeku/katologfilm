...
public class NextFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Films>> {
    ...
    @Override
    public Loader<ArrayList<Films>> onCreateLoader(int i, Bundle args) {
        String sFilm = "";
        if (args != null) {
